...
function validateTraditional(plan) {
  return validateLessonPlan({
    ...
    lessonContext: {
      ...
      lessonContent: "يتناول الدرس خطوات دورة الماء: التبخر والتكاثف والهطول وأثر حرارة الشمس.",
      subject: "علوم",
      grade: "خامس",
      unit: "الماء في الطبيعة",
    },
...
test("repairs traditional timing to exact duration without changing schema", () => {
  ...
  plan.activities = [
    "يناقش الطلاب مع المعلم فكرة دورة الماء ويراجعون صور الخطوات على السبورة وفق طريقة المناقشة والحوار (2 دقائق) (7 دقائق)",
  ...
  plan.assessment[0] =
    "اختيار متعدد (1 دقيقة): ما الترتيب الصحيح لخطوات دورة الماء؟ (3 دقائق)";
...
test("rejects objectives whose leading verb is not measurable", () => {
  ...
  plan.learning_outcomes[0] =
    "أن يكون الطالب قادرا على شرح خطوات دورة الماء من خلال مخطط مبسط بدقة.";
...
test("repairs activities missing explicit strategy linkage", () => {
  const plan = createTraditionalPlan();
  plan.activities[0] =
    "يناقش الطلاب مع المعلم فكرة دورة الماء ويراجعون صور الخطوات على السبورة (14 دقائق)";
